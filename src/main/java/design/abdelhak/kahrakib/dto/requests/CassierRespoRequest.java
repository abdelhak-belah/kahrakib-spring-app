...
public class CassierRespoRequest {
    ...
    public CassierRespoRequest() {
    }

    public CassierRespoRequest(String email, String motDePasse, String nom, String prenom, Date dateNaissance, String chantierImputation) {
        this.email = email;
